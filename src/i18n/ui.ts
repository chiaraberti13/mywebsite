...
export const ui = {
  it: {
    ...
    "footer.nav": "Naviga",
    "stats.efficiency": "Riduzione dei tempi in un processo reale",
  ...
  en: {
    ...
    "nav.instruction": "Education path",
    ...
    "footer.nav": "Explore",
    "stats.efficiency": "Processing-time reduction in a real workflow",
